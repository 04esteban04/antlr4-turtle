...
public interface LogoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LogoParser#variableExpreson}.
	 * @param ctx the parse tree
	 */
	void enterVariableExpreson(LogoParser.VariableExpresonContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoParser#variableExpreson}.
	 * @param ctx the parse tree
	 */
	void exitVariableExpreson(LogoParser.VariableExpresonContext ctx);
	/**
	 * Enter a parse tree produced by {@link LogoParser#coloExpresion}.
	 * @param ctx the parse tree
	 */
	void enterColoExpresion(LogoParser.ColoExpresionContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoParser#coloExpresion}.
	 * @param ctx the parse tree
	 */
